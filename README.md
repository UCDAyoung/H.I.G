...
[샤잠 kit 애플공식문서](https://developer.apple.com/kr/shazamkit/) <br> 
샤잠키트 속에 다양한 노래나, 관련 오디오 정보들이 많이 들어가 있어 쉽게 빠르게 찾을 수 있는게 장점이다. <br>
또한, 내가 녹음한?커스텀?한 오디오를 넣어놓고 인식하게 할 수도 있다고 한다. <br> 

오디오 기능 이상의 다양한 경험을 제공할 수 있게 커스텀할 수 있다. <br>
- 음악 장르에 따라 그에 상응하는 그래픽도 제공한다. 
- 캡션 및 수화를 제공하고 시각 장애인들도 사용할 수 있게 할 수 있다.


접근 권한 알람 <br> 
- 다른 접근 권한이 필요할 때 알람을 띄운 것과 같이 내용에  "왜 필요한지", "허용이 되면 어떤걸 할 수 있는지"등이 들어가 있어야한다. 

접근 허용 후 <br>
- 접근 허용 시 가능한 한 빨리 녹음을 중지하라고 한다.?
- icloud에 저장할 수 있도록 한다. 
